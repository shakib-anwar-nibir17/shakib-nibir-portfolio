...
const ClipPathLinks = () => {
  return (
    <div className="divide-y divide-dark border border-dark">
      <div className="grid grid-cols-8 divide-x divide-dark">
        ...
        <LinkBox Icon={SiReactrouter} href="#" />
        <LinkBox Icon={SiReacthookform} href="#" />
      </div>
      <div className="grid grid-cols-5 divide-x divide-dark">
        <LinkBox Icon={SiKnexdotjs} href="#" />
        <LinkBox Icon={SiNodedotjs} href="#" />
        <LinkBox Icon={SiExpress} href="#" />
        <LinkBox Icon={SiMongodb} href="#" />
        <LinkBox Icon={SiMongoose} href="#" />
      </div>
      <div className="grid grid-cols-6 divide-x divide-dark">
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute inset-0 grid place-content-center bg-primaryDark text-white"
      >
